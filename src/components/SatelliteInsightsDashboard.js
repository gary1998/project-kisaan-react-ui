    ...
    render(){
        return(
            <>
                {
                    (!this.props.fields)?
                    <Loading withOverlay={false} active={!this.props.fields}/>:
                    <>
                        ...
                        <br/>
                        {
                            ...
                            <Row>
                                ...
                                <Column>
                                    <Card heading="Crop Health" icon={<Image32 />} subtitle={new Date(this.props.fieldData.satelliteImageryData.body[this.props.fieldData.satelliteImageryData.body.length-1].dt*1000).toLocaleString()+" by "+this.props.fieldData.satelliteImageryData.body[this.props.fieldData.satelliteImageryData.body.length-1].type}>
                                        <div className="card-body">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <span className="card-body-value">{this.props.fieldData.satelliteImageryData.ndviStats.mean.toPrecision(2)}</span>
                                        </div>
